...
@Component({
  ...
  template: `
    <div dir="ltr" class="fab !relative w-7 h-7 inset-0 gap-1">
      ...
      <div class="-mr-1 bg-base-100 p-2 pl-10 h-12 rounded-field shadow cursor-pointer flex flex-nowrap items-center transition-all hover:shadow-lg">
      ...
      <div class="-mr-1 bg-base-100 p-2 pl-10 h-12 rounded-field shadow cursor-pointer flex flex-nowrap items-center transition-all hover:shadow-lg">
        <div class="flex flex-col items-end">
          <strong>فایل</strong>
          <span class="text-xs text-base-content/70" dir="rtl">انتخاب zip, rar, 7z, tar تا ۱۰۰ مگابایت</span>
        </div>
