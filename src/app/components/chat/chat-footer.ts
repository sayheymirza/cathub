...
@Component({
  ...
  imports: [FormsModule],
  template: `
    <div dir="ltr" class="fab !relative w-7 h-7 inset-0">
  ...
  `,
  host: {
    class: 'flex flex-nowrap items-end gap-4 bg-base-100/70 backdrop-blur border border-base-content/30 rounded-xl min-h-12 p-2 focus-within:shadow-xl focus-within:border-primary transition-all',
  }
})
